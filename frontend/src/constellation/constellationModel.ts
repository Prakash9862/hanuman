...
const visualMetadata: Record<string, Omit<ConstellationConnector, keyof ConnectorDefinition>> = {
  ...
  github: { x: 51, y: 11, size: 'medium', palette: 'graphite', healthEndpoint: '/github/ping' },
  gmail: { x: 10, y: 14, size: 'medium', palette: 'coral', healthEndpoint: '/gmail/status' },
  ...
  stockfish: { x: 10, y: 89, size: 'small', palette: 'steel', healthEndpoint: '/resources/programs/stockfish/status' },
  openai: { x: 12, y: 53, size: 'medium', palette: 'jade', healthEndpoint: '/openai/ping' },
  youtube: { x: 91, y: 16, size: 'medium', palette: 'red', healthEndpoint: '/resources/youtube/status' },
  gallica: { x: 73, y: 91, size: 'medium', palette: 'gold', healthEndpoint: '/resources/gallica/status' },
  imslp: { x: 54, y: 93, size: 'small', palette: 'rose', healthEndpoint: '/resources/imslp/status' },
