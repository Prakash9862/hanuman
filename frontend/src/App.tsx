...
function OverviewPage() {
  ...
  return <div className="page overview-page">
    ...
    <section className="overview-grid">
      ...
      <article className="overview-card overview-card--activity"><div className="card-heading"><Activity size={18} /><span>Activité récente</span></div><div className="activity-list"><span><b>Obsidian ↔ Notion</b><small>Inventaire disponible</small></span><span><b>Wikipédia → Notion</b><small>Espace de publication disponible</small></span><span><b>GitHub → Notion</b><small>Connexion à consolider</small></span></div></article>
